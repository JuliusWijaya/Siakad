    ...
    <div class="row">
        <div class="col-10 pt-5" style="margin: 0 auto;">
            @if(session()-> has('success')) 
                <div class="alert alert-success alert-dismissible fade show" role="alert">Hai 
                        ...
                        <div class="input-group input-group-sm" style="width: 250px;">
                            <form action="/mahasiswa" method="GET" class="d-inline">
                                <div class="input-group mb-3">
                                    <input type="text" name="keyword" class="form-control" value="{{request('keyword')}}" placeholder="Search Name">
        ...
        @else
            <p class="alert alert-danger text-center text-dark mt-5 col-md-5 text-white" style="margin: 0 auto">Not Found Mahasiswa</p>
        @endif
    </div>
@endsection
